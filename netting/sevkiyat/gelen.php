...
if (isset($_POST['sevkiyatekle'])) {
    ...
    */
    ...
    if (mysqli_query($db, $sql)) {
        ...
        $sqlBiyet = "INSERT INTO tblstokbiyet (partino, firmaId, alasimId, cap, boy, sevkiyatId, barkodNo)  VALUES ";
        for ($i = 0; $i < count($biyetpartino); $i++) {
            ...
            for ($j = 0; $j < $biyetadetbiyet[$i]; $j++) {
                ...
                $sqlBiyet = $sqlBiyet . " ('$biyetpartinosatir', '$biyetfirmasatir', '$biyetalasimsatir','$biyetcapsatir', '$biyetboysatir',  '$sevkiyatId', '$barkod'),";
            }
        }
        ...
        for ($i = 0; $i < count($boyapartino); $i++) {
            ...
            for ($j = 0; $j < $boyaadetsatir; $j++) {
                $barkod = $firmaKod . mt_rand();
                $sqlBoya = $sqlBoya . " ('$boyapartinosatir', '$boyafirmasatir', '$boyapboyaidsatir','$boyasicakliksatir', '$boyacinssatir',  '$sevkiyatId', '$barkod', '$boyakilosatir'),";
            }
        }
        ...
        $sqlMalzeme = "INSERT INTO tblstokmalzeme (partino, firmaId, malzemeId, sevkiyatId, barkod)  VALUES ";
        for ($i = 0; $i < count($boyapartino); $i++) {
            ...
            for ($j = 0; $j < $malzemeadetsatir; $j++) {
                $barkod = $firmaKod . mt_rand();
                $sqlMalzeme = $sqlMalzeme . " ('$malzemepartinosatir', '$malzemefirmasatir', '$malzemeidsatir', '$sevkiyatId', '$barkod'),";
            }
        }
        ...
        for ($i = 0; $i < count($profilprofilId); $i++) {
            ...
            '$profilicadet[$i]', '$profilpaketAdet[$i]', '$profiltoplamadet[$i]','$siparisno[$i]', '$sevkiyatId'),";
        }
